...
import 'package:sudoko/boxInner.dart';
import 'package:sudoko/focusClass.dart';
...
class _SudokuWidgetState extends State<SudokuWidget> {
                  ...
                  itemBuilder: (BuildContext buildContext, index) {
                    ...
                    return Container(
                      ...
                      child: GridView.builder(
                        ...
                        physics: ScrollPhysics(),
                        itemBuilder: (BuildContext buildContext, indexChar) {
                          ...
                          else if (blokChar.isExist) color = Colors.red;
  ...
  generatePuzzle() {
    boxInners.clear();
    var sudokuGenerator = SudokuGenerator(emptySquares: 52); //2 or 52
